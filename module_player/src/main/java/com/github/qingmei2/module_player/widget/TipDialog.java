...
import com.github.qingmei2.module_player.utils.DensityUtil;
...
public class TipDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public TipDialog create(){
            ...
            switch (type){
                case TYPE_DEFAILD:
                    params.width = DensityUtil.dip2px(mContext,300);
                ...
                case TYPE_MESSAGE_ONLY:
                    ...
                    params.width = DensityUtil.dip2px(mContext,150);
                    params.height = DensityUtil.dip2px(mContext,90);
                    contentWrap.setLayoutParams(params);
                    addTextView(contentWrap);
                    break;
                case TYPE_IMG_ONLY:
                ...
                case TYPE_LOADING:
                    ...
                    if (TextUtils.isEmpty(message)){
                        addTextView(contentWrap,mContext.getResources().getString(R.string.loading));
                    }else {
                        addTextView(contentWrap);
                    }
                    break;
                case TYPE_SUCCESS:
                    ...
                    params.height = DensityUtil.dip2px(mContext,180);
                    contentWrap.setLayoutParams(params);
                    addImageView(contentWrap,R.drawable.icon_delete_tips);
                    if (TextUtils.isEmpty(message)){
                        addTextView(contentWrap,mContext.getResources().getString(R.string.operate_success));
                    }else {
                        addTextView(contentWrap);
                    }
                    break;
        ...
        private void addTextView(ViewGroup rootView, String tip){
            ...
            tipView.setTextColor(ContextCompat.getColor(mContext, R.color.alivc_white));
